...
namespace SharedAspectsService.Formats
{
    public class CustomJwtFormat : ISecureDataFormat<AuthenticationTicket>
    {
        private readonly OAuthAuthorizationServerOptions _options;

        public CustomJwtFormat(OAuthAuthorizationServerOptions options)
        {
            _options = options;
        }
        ...
        public string Protect(AuthenticationTicket data)
        {
            ...
            var audience = "all";
            //string converted = "IxrAjDoa2FqElO7IhrSrUJELhUckePEPVpaePlS_Xaw".Replace('-', '+');
